...
### Chores
- **deps:** Bump chia-wallet-sdk to 0.36 (#7)

## [0.7.0] - 2026-08-16

### Features
- **melt:** Melt a DID singleton, ending its lineage (#6)

## [0.6.0] - 2026-08-09

### Features
- Add spend_did_with_conditions and refuse Owner::Custom on create (#5)
...
### Features
- Resolve a DID's current XCH payment address from chain (resolve_xch_address) (#3)
